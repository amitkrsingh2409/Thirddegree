...
def dump_client_files(client, directory, file_name, path_name, file_size):
    ...
    client.bandwidth = prev_bandwidth + int(file_size)*1024*1024
    client.storage = prev_storage + int(file_size)*1024*1024
    client.save()
